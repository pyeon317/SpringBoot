...
public class ViewController {
	...
	//a링크요청
	@GetMapping("/quiz_result01/{a}/{b}/{c}")
	public String quiz_result01(@PathVariable("a") int sno,
								@PathVariable("b") String first,
								@PathVariable("c") String last) {
		
		System.out.println("넘어온 값:" + sno + ", " + first + ", " +  last);
		
		return "view/quiz_result01";
	}
	
	@GetMapping("/quiz_result02")
	public String quiz_result02(@ModelAttribute("sno") int sno,
								@ModelAttribute("name") String name) {
		
		System.out.println(sno);
		System.out.println(name);
		
		return "view/quiz_result02";
	}
