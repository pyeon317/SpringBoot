...
public class RestBasicController {
	...
	public String basic() {
		...
		return "<h3>hello world</h3>"; //뷰 리졸버의 합성 경로
	}
	...
	//데이터를 받는 방법
	//get => 쿼리스트링 or 쿼리파라미터 이용해서 '주소'에 담아서 넘겨줌
	//post => 폼형식 or json을 이용해서 'body'에 담아서 넘김
	...
	public SimpleVO getJSON2(@RequestBody Map<String, Object> map) {//맵 사용
	...
	////////////////////////////////////////////////////////////
	//consumers : 반드시 이 타입으로 보내라! 명시

	//produces : 내가 이 타입으로 줄게! 명시 (default = json), xml을 사용하려면 xml데이터바인딩 라이브러리 필요
	...
	public ResponseEntity<SimpleVO> createResponse() {//vo int string 다 됨
...
//	@GetMapping("/api/v1/v1getData/{num}/{name}")   왜 안되냐
//	public SimpleVO v1getData(@PathVariable("num")int num,
...
//	}
	 ...
	 */
	//@CrossOrigin({"http://localhost:3000","~~~"}) 허용한 여러개의 서버요청 허용
